      ...
      <div className="max-w-6xl mx-auto space-y-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-border pb-8">
          <div className="space-y-4">
            <h2 className="text-4xl md:text-6xl font-serif leading-none">Compatible Archives.</h2>
            <p className="text-sm font-mono uppercase tracking-[0.3em] opacity-50">Supported Protocol Integration List</p>
          </div>
